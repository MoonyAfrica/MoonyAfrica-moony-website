...
function requiredPermissions(pathname: string): string[] | null {
  ...
  if (pathname.startsWith("/admin/crm") || pathname.startsWith("/admin/opportunites") || pathname.startsWith("/admin/scoring") || pathname.startsWith("/admin/previsions") || pathname.startsWith("/admin/playbooks")) return ["crm.read"];
