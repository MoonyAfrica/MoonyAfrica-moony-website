...
export async function POST(request:Request){
 ...
 if(action==="capture"){
  ...
  await writeAuditLog(supabase,session,"crm.executive_report_capture","crm_executive_report",saved.data.id,`Board pack capturé · ${title}`,{periodMonth,dataQuality:metrics.dataQuality,fx:metrics.fx});return NextResponse.json({ok:true,report:saved.data});
 }
