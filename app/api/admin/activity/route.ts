...
function hrefFor(module: string, row: AuditRow) {
  ...
  if (row.action.includes("revenue_forecast") || row.entity_type === "crm_revenue_forecast" || row.entity_type === "crm_revenue_forecast_settings" || row.entity_type === "crm_client_growth") return row.entity_type === "crm_client_growth" && row.entity_id ? `/admin/customer-success/revenue?growth=${row.entity_id}` : "/admin/customer-success/revenue";
  ...
  if (row.action.includes("customer_success") || row.action.includes("customer_review") || row.action.includes("nps_")) return row.entity_id ? `/admin/customer-success?client=${row.entity_id}` : "/admin/customer-success";
