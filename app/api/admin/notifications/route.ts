...
export async function GET(request: Request) {
  ...
  if (!generated.error) {
    const crmSources = ["crm_proposal","crm_onboarding","crm_customer_success","crm_retention","crm_success_plan","crm_account_governance","crm_executive_portfolio","crm_escalation","crm_revenue_forecast","crm_billing","crm_collections"];
